...
const Pay = () => {
  ...
  const handlePlaceOrder = () => {
    if (firstName && lastName && stateVal && district && phoneNumber && selectedPaymentOption) {
      ...
      if (selectedPaymentOption === 'directBankTransfer' && paymentScreenshot) {
        ...
        console.log('Direct Bank Transfer - Payment Screenshot:', paymentScreenshot);
    ...
    <table className="personal-info-table">
      <tbody>
        <tr>
          ...
          <td>
            <input type="text1" id="firstName"  value={firstName} onChange={(e) => setFirstName(e.target.value)} required />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text1" id="lastName" value={lastName} onChange={(e) => setLastName(e.target.value)} required />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text1" id="stateVal" value={stateVal} onChange={(e) => setStateVal(e.target.value)} required />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <input type="text1" id="district" value={district} onChange={(e) => setDistrict(e.target.value)} required />
          </td>
        </tr>
        <tr>
          <td>
...
<div className='box1'>
  ...
  <div className='gh'>
    <label>
      <input type="radio" name="paymentOption" value="cashOnDelivery" onChange={handlePaymentOptionChange}
/>
      Cash on Delivery
    </label>
    <label>
      <input type="radio" name="paymentOption" value="directBankTransfer"               onChange={handlePaymentOptionChange}
/>
  ...
  <div className='ij' id="directBankDetails" style={{ display: selectedPaymentOption === 'directBankTransfer' ? 'block' : 'none' }}>
  <p>Bank Details:</p>
  ...
  <div className="file-upload">
    ...
    {paymentScreenshot && (
      <div className="uploaded-file">
        ...
        <div className='kl' id="khaltiPaymentDetails" style={{ display: selectedPaymentOption === 'onlinePayment' ? 'block' : 'none' }}>
      ...
      <button  className='po' onClick={handlePlaceOrder} >Place Order</button>
    </div>
  );
};
